package demo.jpa_mysql_postgres;

import demo.jpa_mysql_postgres.postgres.repositories.UserDao;
import demo.jpa_mysql_postgres.services.UserService;
...
public class JPAMySQLPostgresApplication implements CommandLineRunner {
	...
	public static void main(String[] args) {
		SpringApplication.run(JPAMySQLPostgresApplication.class, args);
	}
